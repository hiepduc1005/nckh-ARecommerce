...
const AdminBrand = () => {
  ...
  const handleCreateBrand = async () => {
    ...
    if (imageCreateRequest) {
      ...
      formdata.append(
        "brand",
        new Blob([JSON.stringify(formCreateBrand)], {
  ...
  const handleEditBrand = async () => {
    ...
    if (imageUpdateRequest) {
      ...
      formdata.append(
        "brand",
        new Blob([JSON.stringify(formUpdateBrand)], {
          type: "application/json",
        })
      );
            ...
            <tbody>
              {brands.map((brand) => (
                <tr key={brand.id}>
                  ...
                  <td className="brand-products truncate">
                    {brand.totalProducts}
                  </td>

                  <td className="brand-date truncate">
                    {formatToVNDate(brand.createdAt)}
                  </td>
