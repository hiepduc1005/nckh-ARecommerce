  ...
  return (
    <div className="return-policy-container">
      <div className="return-policy-content">
        ...
        <div className="policy-section">
          <h2>REFUNDS</h2>
          <p>After receiving your return and inspecting the condition of your item, we will process your return. Please allow at least two (2) days from the receipt of your item to process your return. Refunds may take 1-2 billing cycles to appear on your credit card statement, depending on your credit card company. We will notify you by email when your return has been processed.</p>
        </div>
