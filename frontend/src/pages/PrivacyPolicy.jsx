...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    document.title = "Chính sách bảo mật | HHQTV Store";
  }, []);
    ...
    <div className="privacy-policy-container" id="start">
      <div className="privacy-policy-content">
        ...
        <div className="policy-intro">
          <p>
            This Privacy Notice for HHQTV ("we," "us," or "our"), describes how
        ...
        <div className="policy-section" id="summary">
          ...
          <p className="italic">
            ...
            <span className="link" onClick={() => scrollToSection("toc")}>
              table of contents
            </span>{" "}
          ...
          <div className="key-points">
            <p>
              ...
              <span className="link" onClick={() => scrollToSection("collect")}>
            ...
            <p>
              ...
              <span className="link" onClick={() => scrollToSection("process")}>
            ...
            <p>
              ...
              <span className="link" onClick={() => scrollToSection("share")}>
            ...
            <p>
              ...
              more about{" "}
              <span className="link" onClick={() => scrollToSection("rights")}>
                your privacy rights
              </span>
              .
            </p>
            ...
            <p>
              ...
              <span className="link">data subject access request</span>, or by
        ...
        <div className="policy-section" id="toc">
          ...
          <ol className="toc-list">
            ...
            <li>
              <span className="link" onClick={() => scrollToSection("cookies")}>
                DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
              </span>
            </li>
            <li>
              <span className="link" onClick={() => scrollToSection("social")}>
            ...
            <li>
              <span className="link" onClick={() => scrollToSection("minors")}>
            ...
            <li>
              <span className="link" onClick={() => scrollToSection("dnt")}>
                CONTROLS FOR DO-NOT-TRACK FEATURES
              </span>
            </li>
            <li>
              <span className="link" onClick={() => scrollToSection("updates")}>
            ...
            <li>
              <span className="link" onClick={() => scrollToSection("review")}>
        ...
        <div className="policy-section" id="minors">
          ...
          <p>
            ...
            under age 18, please contact us at _________.
          </p>
        </div>
