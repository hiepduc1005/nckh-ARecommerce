                  ...
                  <div className="info-group">
                    ...
                    <div className="info-row">
                      ...
                      <span className="info-value">
                        {product.brandResponse?.name || "N/A"}
                      </span>
                    </div>
                    <div className="info-row">
                      ...
                      <span className="info-value">
                        {product.tags?.length ? (
                          product.tags.map((tag) => (
                            <span key={tag.tagName} className="badge badge-tag">
                              {tag.tagName}
                            </span>
                          ))
                        ) : (
                  ...
                  <div className="info-group">
                    ...
                    <div className="info-row">
                      ...
                      <span className="info-value">
                        ...
                        {product.ratingResponses?.length || 0} reviews)
                      </span>
                    </div>
                    {product?.modelPath && (
                      <div className="info-row">
                        <span className="info-label">3D Model:</span>
                        <span className="info-value">
                          <button
                            className="view-model-3d-btn"
                            onClick={() => setShowModel3D(true)}
                          >
                            <FontAwesomeIcon icon={faCube} /> View 3D Model
                          </button>
                        </span>
                      </div>
                    )}
                      ...
                      {variants?.map((variant) => {
                        return (
                          <tr key={variant.id}>
                            ...
                            <td>
                              {variant.attributeValueResponses &&
                              variant.attributeValueResponses.length > 0 ? (
