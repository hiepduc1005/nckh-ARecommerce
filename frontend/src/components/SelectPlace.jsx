...
import { calculateDistance, LOCATIONIQ } from "../utils/ultils";
...
const SelectPlace = ({ onChange, defaultValue = null, setDistance }) => {
  ...
  useEffect(() => {
    if (selectedLocation) {
      const distance = calculateDistance(cordinate.lat, cordinate.lon);
      if (distance) {
          ...
          {selectedLocation ? (
            ...
            >
              ...
              <Marker position={[selectedLocation.lat, selectedLocation.lon]}>
                <Popup>{selectedLocation.fullAddress}</Popup>
              </Marker>
            </MapContainer>
          ) : (
