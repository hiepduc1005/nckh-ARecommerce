              ...
              <div key={order.id} className="order-card">
                <div className="order-header">
                  <div className="order-info">
                    <span className="order-date">Đặt ngày: {formatToVNDate(order.createdAt)}</span>
                ...
                <div className="order-footer">
                  <div className="order-summary">
                    ...
                    <div className="price-info">
                      ...
                      <span className="order-total-price">{formatCurrency(order.totalPrice)}</span>
                    </div>
                  </div>
                  <div className="order-actions">
                    ...
                    {order.orderStatus === 'SHIPPED' && (
                      <>
                        <button className="track-btn" onClick={() => handleNavigatePurchaseProgress(order.code)}>Theo Dõi Đơn Hàng</button>
                        <button className="confirm-delivery-btn">Xác Nhận Đã Nhận</button>
                      </>
                    )}
                    {order.orderStatus === 'REFUNDED' && (
                      <>
                        <button className="buy-again-btn">Mua Lại</button>
                        <button className="details-btn">Xem Chi Tiết Hoàn Tiền</button>
                      </>
                    )}
                  </div>
                </div>
